...
if(CLIENT) then
	...
	local function End()
		local snd = CreateSound(LocalPlayer(), "null.wav")
		snd:Play()
	...
	local function EnableHell()
		...
		local function LastScene()
			...
			NewTimerSimple(0.3, function() surface.PlaySound("null.wav") end)
		...
		NewTimerSimple(7, function()
			...
			NewTimerSimple(6, function()
				...
				sound.Play("null.wav", LocalPlayer():GetPos(), math.random(50, 120), math.random(30, 70), 1)
				util.ScreenShake(LocalPlayer():GetPos(), 3, 55, 5, 1000)
				...
				NewTimerSimple(9, function()
					...
					for i = 1, 16 do
						sound.Play("null.wav", LocalPlayer():GetPos(), 120, 80, 1)
					end
				...
				NewTimerSimple(80, function()
					...
					for i = 1, 8 do
						sound.Play("null.wav", LocalPlayer():GetPos(), math.random(50, 120), 80, 1)
					end
